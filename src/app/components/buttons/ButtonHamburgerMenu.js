...
const ButtonHamburgerMenu = ({ handleClick, secondProp }) => {
  return (
    <span
      onClick={handleClick}
      className="fixed right-5 rounded shadow-xl p-2 bg-appGrey/70 border border-appBlue/80 hover:-rotate-12 cursor-pointer transform transition-transform duration-300"
    >
      <div
