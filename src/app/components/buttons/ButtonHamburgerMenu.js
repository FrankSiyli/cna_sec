...
const ButtonHamburgerMenu = ({ handleClick, secondProp }) => {
  return (
    <span
      onClick={handleClick}
      className="fixed z-30 right-5 top-5 rounded shadow-xl p-2 bg-appBlue/70 hover:bg-appBlue border border-appGrey/50 cursor-pointer"
    >
      <div
      ...
      <div
        className={`w-4 my-2 mx-auto border border-appGrey transform transition-all duration-700 ${
