  ...
  return (
    <main className="flex flex-col items-center justify-between p-2">
      ...
      <div className="mt-40 text-center">            
        ...
        <p>
          Ich bin Frank aus Hamburg und unterstütze seit 2017 Athletinnen und Athleten
          dabei, ihre Träume zu verwirklichen – von der ersten Sprintdistanz bis zum
          Ultra-Event
        </p>
      ...
      <div className="my-20 text-center ">
          <div className="mb-20 text-center">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-center">
                {" "}
                <span className="text-appBlue mr-1">#</span>regelmäßiger und unbegrenzter
                Austausch{" "}
              </div>
              <div className="flex justify-center">
